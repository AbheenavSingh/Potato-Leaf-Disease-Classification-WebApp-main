...
def predict_class(image) :
    with st.spinner('Loading Model...'):
        classifier_model = keras.models.load_model('Potato-Leaf-Disease-Classification-WebApp-main/final_model.h5', compile = False)
...
<div class="footer">
<p align="center"> <a href="https://www.linkedin.com/in/ronylpatil/">Developed with ❤ by Bhavesh And Abhinav</a></p>
</div>
        """
